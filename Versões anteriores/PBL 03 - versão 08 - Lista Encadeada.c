...
//====================SESSÃO DECLARAÇÃO DE FUNÇÕES.==================
	...
	Problema* insere_ordenado();
								int recebe_ano();
			void listar();
												float recebe_semestre();
												void listar_por_semestre();
												int recebe_problema();
												void listar_por_problema();
	Problema* ler_ano();
...
//=====================================================================================================================================================================================
void exibir_conteudo(char arquivo[]){//função que ler o conteudo direto do arquivo. 
...
//=====================================================================================================================================================================================
void listar(Problema *l,  int informacao){	
	Problema* imprime_o = l;
	printf("%d\n", informacao);
	while(imprime_o != NULL){
		if(imprime_o->problema == informacao){
			printf("Ano: %d\n", imprime_o->ano);
			printf("Problema: %d\n", imprime_o->problema);
			printf("Semestre: %.1f\n", imprime_o->semestre);
			printf("Titulo: %s\n", imprime_o->titulo);
			printf("Discritivo: %s\n", imprime_o->discritivo);
			
		}
		imprime_o = imprime_o->prox_problema;
	}
}
//=====================================================================================================================================================================================
void listar_por_semestre(Problema *l, double semestre){
	Problema* imprime_o = l;
	while(imprime_o != NULL){
		if(imprime_o->semestre == semestre){
			printf("Ano: %d\n", imprime_o->ano);
			printf("Problema: %d\n", imprime_o->problema);
			printf("Semestre: %.1f\n", imprime_o->semestre);
			printf("Titulo: %s\n", imprime_o->titulo);
