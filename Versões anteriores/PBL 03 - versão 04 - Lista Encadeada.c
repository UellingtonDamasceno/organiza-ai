	...
	do{
		...
		if(verifica_se_vazio(arquivo) == TRUE){
			...
			for(i = 0; i < qtd_linhas; i++){
				printf("chegou aki 02\n");
				novo_problema = preencher_celula(arquivo);
				printf("preencheu a celula\n");
				printf("%d", novo_problema.ano);
				if (e_igual(*l, &novo_problema) == TRUE)//verifica se o arquivo ja existe na lista.
					...
					insere_ordenado(*l, &novo_problema);
...
//======================================================================================================================================================================================
Problema preencher_celula(char arquivo[]){
	char ch;
		Problema *o;
		
		FILE *pegar_no_arq = fopen(arquivo, "r");
		o = (Problema*) malloc(sizeof(Problema));//cria uma nova celula.
